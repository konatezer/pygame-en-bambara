...
class Acteur(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load("img/acteur.png").convert()
        self.image.set_colorkey((255, 255, 255)) # coleur en rgb
...
class Bandit(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load("img/bandit.png").convert()
        self.image.set_colorkey((255, 255, 255)) # coleur en rgb
...
while execution:
    ...
    fenetre.blit(bandit_sidi.image, bandit_sidi.rect)
    fenetre.blit(sidi.image, sidi.rect) # acteur sidi
